<div class="row border border-green">
        ...
        <a class="col-2" href="${pageContext.request.contextPath}/home}" ><fmt:message key="layout.header.homepage"/></a>
        <a class="col-2" href="${pageContext.request.contextPath}/user/userprofile}"><fmt:message key="layout.userheader.cabinet"/></a>
        </div>
        </div>
        </nav>
        <div class="col-md-1">
    ...
    <c:if test="${isAutorise}">
        ...
        <div class="col-md-6">
        <a class="btn border" href="${pageContext.request.contextPath}/logout}" ><fmt:message key="layout.header.link.logout"/></a>
        </div>
        </div>
    </c:if>
    <c:if test="${!isAutorise}">
        <div class="row">
        <a class="btn btn-success" href="${pageContext.request.contextPath}/login}" type="submit" ><fmt:message key="lofinpage.button.login"/></a>
